<?php $this->load->view("layout/header");?>
    <body id="body_home" class="at-page site itemid-101 at-home">
		    				...
		    				<div class="row">
				    			<div class="col-sm-12 col-lg-4 col-xl-4 col-md-4">
				    				<div class="brand-logo-wrap">
				    					<a class="navbar-brand" href="index.html"><img src="<?= base_url();?>assets/images/logo.png" class="img-fluid" alt="Compare Tree"></a>
				    				</div>
				    			</div>
				    				...
				    				<nav class="navbar navbar-expand pull-right">				    					
										...
										<div class="collapse navbar-collapse" id="navbarSupportedContent">
					    					<ul id="menu-primary_navigation" class=" menu menu-horizontal nav navbar-nav">
												...
												<li class="menu-item"><a class="menu-link" href="javascript:void(0)">About us</a></li>
												<li class="menu-item"><a class="menu-link" href="javascript:void(0)">Contact us</a></li>
  				...
  				<div class="container">
  					<div class="inner-block at-paddingT15 at-paddingB15 at-paddingT50 at-paddingB100">
  						<div class="row">
  							...
  							<div class="col-sm-12 col-lg-6 col-xl-6 col-md-6 at-paddingL100 at-paddingT50">  								
  								<div class="insurance-content-wrap">
									<h3>Lorem ipsum dolor site</h3>
									<h1>The smart way to buy insurance.</h1>
									<div class="tagline"> Compare rates from top rated carriers in less than <span>3 minutes</span></div>
									<form class="form-inline form-home form-action" data-popunder="false" action="http://localhost/compareTree/index.php/leads" id="zip-form" method="post">
