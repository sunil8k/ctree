  						...
  						<div class="row">							
  							...
  							<div class="col-sm-9 col-lg-9 col-xl-9 col-md-9">  								
  								<div class="insurance-content-wrap">
									<h3>Add New User</h3>
                                    <form action="<?= base_url();?>index.php/agent/updateUser" name="edit" method="post" onSubmit="return validation();" >
                                    <div class="row">
                                    	<label style="width:200px;"><strong>Username:</strong> </label><input type="text" readonly class="form-control" name="username" id="username" value="<?php echo $profiles->username;?>" onChange="checkUsername(this.value)" ><span id="username_txt"></span>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                    	<label style="width:200px;"><strong>Mobile:</strong> </label><input type="text" class="form-control" name="mobile" id="mobile" maxlength="12" placeholder="+1 2344567890" value="<?php echo $profiles->mobile;?>" ><span id="mobile_txt"></span>
                                    </div>
                                    <div class="row">
                                    	<label style="width:200px;"><strong>Gender:</strong> </label>
                                        <select name="gender" class="form-control">
                                        	<option value="male" <?php echo (($profiles->gender) == 'male')?'selected':'';?>>Male</option>
                                        	<option value="female" <?php echo (($profiles->gender) == 'female')?'selected':'';?>>female</option>
                                        </select>
                                        <span></span>
                                    </div>
                                    <div class="row">
