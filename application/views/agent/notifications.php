  						...
  						<div class="row">							
  							...
  							<div class="col-sm-9 col-lg-9 col-xl-9 col-md-9">  								
  								<div class="insurance-content-wrap">
                                    ...
                                    <div class="row">
                                    	<div class="col-sm-6 col-lg-6 col-xl-6 col-md-6"><label style="width:200px; text-align:left;"><span><?php echo $notification->message;?></span></label></div>
                                        <div class="col-sm-3 col-lg-3 col-xl-3 col-md-3"><?php echo $notification->date_time;?></div>
                                    </div>
                                   <?php }?>
								</div>
  							</div>
