  						...
  						<div class="row">							
  							...
  							<div class="col-sm-9 col-lg-9 col-xl-9 col-md-9">  								
  								<div class="insurance-content-wrap">
									<h3>My Banners<span style="float:right;"><a href="<?=base_url()?>index.php/agent/addBanner" title="Create New Banner">+</a></span></h3>
                                    ...
                                    <div class="row">
                                    	<div class="col-sm-6 col-lg-6 col-xl-6 col-md-6"><label style="width:200px; text-align:left;"><span>Banner</label></div>
                                        <div class="col-sm-3 col-lg-3 col-xl-3 col-md-3">Status</div>
                                        <div class="col-sm-3 col-lg-3 col-xl-3 col-md-3">Action</div>
                                    </div>
                                    <?php
									foreach($banner as $ban) {?>
                                    <div class="row">
                                    	<div class="col-sm-6 col-lg-6 col-xl-6 col-md-6"><label style="width:200px; text-align:left;"><span><?php echo $ban->banner;?></span></label></div>
                                        <div class="col-sm-3 col-lg-3 col-xl-3 col-md-3"><img src="<?php echo $ban->url;?>" ></div>
                                        <div class="col-sm-3 col-lg-3 col-xl-3 col-md-3"><a href="<?= base_url();?>index.php/agent/bidDetail?lead_id=<?php echo $ban->status;?>" ><?php echo $ban->status;?></a></div>
                                    </div>
                                   <?php }?>
								</div>
  							</div>
