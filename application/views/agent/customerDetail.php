  							...
  							<div class="col-sm-9 col-lg-9 col-xl-9 col-md-9">  								
  								<div class="insurance-content-wrap">
                                    ...
                                    <div class="row">
                                    	...
                                    	<div class="col-sm-6 col-lg-6 col-xl-6 col-md-6"><?php echo $customerDetail->first_name." ".$customerDetail->last_name;?></div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-3 col-lg-3 col-xl-3 col-md-3"><label style="width:200px; text-align:left;">Email</label></div>
                                    	<div class="col-sm-6 col-lg-6 col-xl-6 col-md-6"><?php echo $customerDetail->first_name." ".$customerDetail->email;?></div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-3 col-lg-3 col-xl-3 col-md-3"><label style="width:200px; text-align:left;">Mobile</label></div>
                                    	<div class="col-sm-6 col-lg-6 col-xl-6 col-md-6"><?php echo $customerDetail->first_name." ".$customerDetail->mobile;?></div>
                                    </div>
                                   <?php }?>
								</div>
  							</div>
