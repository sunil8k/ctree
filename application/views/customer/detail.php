  							...
  							<div class="col-sm-9 col-lg-9 col-xl-9 col-md-9">  								
  								<div class="insurance-content-wrap">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-lg-6 col-xl-6 col-md-6"><?php echo $leads->sku;?></div>
                                    </div>
                                    <div class="row">
                                    	<div class="col-sm-3 col-lg-3 col-xl-3 col-md-3"><span>Section</span></label></div>
                                        <div class="col-sm-6 col-lg-6 col-xl-6 col-md-6"><?php echo $leads->section;?></div>
                                    </div>
                                    <div class="row">
                                    	<div class="col-sm-3 col-lg-3 col-xl-3 col-md-3"><span>Address</span></label></div>
                                        <div class="col-sm-6 col-lg-6 col-xl-6 col-md-6"><?php echo $leads->address;?></div>
                                    </div>
                                    <div class="row">
                                    	<div class="col-sm-3 col-lg-3 col-xl-3 col-md-3"><span>City</span></label></div>
                                        <div class="col-sm-6 col-lg-6 col-xl-6 col-md-6"><?php echo $leads->city;?></div>
                                    </div>
                                    <div class="row">
                                    	<div class="col-sm-3 col-lg-3 col-xl-3 col-md-3"><span>Country</span></label></div>
                                        <div class="col-sm-6 col-lg-6 col-xl-6 col-md-6"><?php echo $leads->country;?></div>
                                    </div>
                                    <div class="row">
                                    	<div class="col-sm-3 col-lg-3 col-xl-3 col-md-3"><span>Mobile</span></label></div>
                                        <div class="col-sm-6 col-lg-6 col-xl-6 col-md-6"><?php echo $leads->mobile;?></div>
                                    </div>
                                    <div class="row">
                                    	<div class="col-sm-3 col-lg-3 col-xl-3 col-md-3"><span>Zip</span></label></div>
                                        <div class="col-sm-6 col-lg-6 col-xl-6 col-md-6"><?php echo $leads->zip;?></div>
                                    </div>
                                    <div class="row">
                                    	<div class="col-sm-3 col-lg-3 col-xl-3 col-md-3"><span>Create Date</span></label></div>
                                        <div class="col-sm-6 col-lg-6 col-xl-6 col-md-6"><?php echo date('d/M/Y',strtotime($leads->start_date));?></div>
                                    </div>
                                    <div class="row">
                                    	<div class="col-sm-3 col-lg-3 col-xl-3 col-md-3"><span>Section</span></label></div>
                                        <div class="col-sm-6 col-lg-6 col-xl-6 col-md-6"><?php echo $leads->section;?></div>
