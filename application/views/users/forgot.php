...
<body id="body_leads" class="at-page site itemid-102 at-quote">
    	<div id="at-page-wrapper">
           ...
           <?php
				echo form_open('users/forgot', array('name' => 'login','id' => 'clearingForm'));    
			?>
            ...
            <h3>Forgot Password</h3>
                    ...
                    <div class="form-group">
                       <label>Provider <input type="radio" name="type" value="provider" checked class="form-control"/></label>
                       &nbsp;&nbsp;&nbsp;
                       <label>Seeker <input type="radio" name="type" value="seeker"  class="form-control" /></label>
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" class="btn bg-olive btn-block">Send Mail to your EmailID</button> 
                    </div>
                </div>
                <div class="footer">                                                            
