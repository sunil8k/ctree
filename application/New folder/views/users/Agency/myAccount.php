...
<section id="meet-team">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">Dashboard</h2>
            ...
            <div class="row">
                <div class="col-sm-6 col-md-3">
                    <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="0ms">
                        ...
                        <div class="team-info">
                            <h3>Add Post</h3>
                            <span>You can add new post</span>
                        </div>
                        <p><a href="<?= base_url();?>index.php/post/myPost" >Show My Post</a></p>
                        <p><a href="<?= base_url();?>index.php/post/addPost" >Add New Post</a></p>
                    </div>
                </div>
                <div class="col-sm-6 col-md-3">
                    <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="100ms">
                        ...
                        <div class="team-info">
                            <h3>Edit Account</h3>
                            <span>You can edit your Credential</span>
                        </div>
                        <p><a href="<?= base_url();?>index.php/post/myPost" >Edit Detail</a></p>
                        <p><a href="<?= base_url();?>index.php/post/myPost" >Change Password</a></p>
