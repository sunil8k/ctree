				    			...
				    			<div class="col-sm-12 col-lg-6 col-xl-6 col-md-6">
                                    ...
                                    <div style="float:right;">
                                        ...
                                        <?php if(!($this->session->userdata('id'))) { ?>
                                            <li><a href="<?= base_url();?>index.php/customer/register">Register</a> | <a href="<?= base_url();?>index.php/customer/login">Login</a></li><?php } else { ?>
                                            <li>My Account | <a href="<?= base_url();?>index.php/customer/logout">Logout</a></li><?php }?>
                                        </ul>
                                    </div>
