	...
	<?php $this->load->view("layout/left_content");?>
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>
                        Player List
                        <a href="<?= base_url();?>index.php/users/addPlayer?view=index" style="float: right; margin-right: 10px;">
									  ...
									  <?php
                                          ...
                                          ?>                                       
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo date ("j M Y - h:i a",strtotime($result->created_date));?></td>
                                                <td><?php echo date ("j M Y - h:i a",strtotime($result->last_updated));?></td>
                                                <td>
                                               ...
                                               <?php if($this->session->userdata('user_type')=='admin'){ ?>
                                                ...
                                                <a  href="<?= base_url();?>index.php/users/active?id=<?php echo $result->id; ?>&view=seekers" onclick="return confirm('Are you sure you want to Un-publish ?');" title="Un-publish" ><i class="glyphicon glyphicon-ok-circle"></i></a>
                                                <?php }else { ?>
                                                <a href="<?= base_url();?>index.php/users/active?id=<?php echo $result->id; ?>&view=seekers" onclick="return confirm('Are you sure you want to Publish ?');" title="Publish" ><i class="glyphicon glyphicon-ok-sign"></i></a>
                                                <?php } ?>
                                                <a  href="<?= base_url();?>index.php/users/delete?del=<?php echo $result->id; ?>&view=seekers" onclick="return confirm('Are you sure you want to Delete ?');" title="Delete"><i class="glyphicon glyphicon-remove-circle"></i></a>
                                           		<a href="<?= base_url();?>index.php/users/editUser?id=<?php echo $result->id; ?>&view=seekers" onclick="return confirm('Are you sure you want to Update ?');" title="Update" ><i class="glyphicon glyphicon-pencil"></i></a> 
                                               <?php } ?>
                                                </td>
                                            </tr>
