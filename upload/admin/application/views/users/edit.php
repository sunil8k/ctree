                                 ...
                                 <?php
                                    ...
                                    <div class="box-body">
                                        <div class="form-group" style="display:none;">
                                            ...
                                            <input type="text" class="form-control" id="username" name="username" placeholder="User Name" readonly="readonly" value="<?php echo set_value('username',$data['username']); ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="user_type" id="user_type" class="form-control" >
                                              <option value="agency"<?php echo $data['user_type']=='agency'?'selected="selected"':''; ?> >Agency</option>
                                              <option value="customer" <?php echo $data['user_type']=='customer'?'selected="selected"':''; ?>>Seeker</option>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" id="image" name="image" placeholder="Profile Image" value="<?php echo set_value('image',$data['image']); ?>">
