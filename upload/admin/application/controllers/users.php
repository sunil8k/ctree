...
class Users extends CI_Controller {
	     ...
	     *************************/
		 ...
		 public function player(){
			  $data["results"] = $this->users_model->player();
			  $this->load->view("users/player", $data);
		 }
		 function active(){
			...
			$this->form_validation->set_rules('address','Address','required|trim|xss_clean');
				...
				$message = '<table align="left" border="0" style="font-family: Verdana, Geneva, sans-serif;font-size: 11px;border-width:medium; border:solid; border-spacing:10;border-color:#CCCCCC" width="625">
						<tbody>
							<tr>
								<td valign="">
									<img alt="" src="http://label9420.net/iMemet/administrator/assets/images/logo.png" style="width: 100px; height: 100px;" /></td>
							</tr>
							<tr>
								<td align="justify">
