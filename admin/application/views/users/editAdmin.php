                        ...
                        <!-- left column -->
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="alert alert-success alert-dismissable" style="width:98%;">
                                 ...
                                 <?php
									echo form_open_multipart('users/saveEditAdmin', array('name' => 'change','onsubmit'=>'return validation();')); 
									?>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputPassword1"><em class="star_red">*</em> Picture :</label>
