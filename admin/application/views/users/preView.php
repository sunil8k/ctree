...
<td width="10%" align="center" valign="top">
	<img src="http://localhost/compareTree/<?php echo  $results11[0]['image']?$results11[0]['image']:'userAvatar/avatar.png'; ?>" width="120"  />
...
<tr>
<td align="left"><strong>Marital Status :</strong></td>                                                                                             
<td>
<span><?php  echo  $results11[0]['marital'];  ?></span>
</td>
</tr>
<tr>
