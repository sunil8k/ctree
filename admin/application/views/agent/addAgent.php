                        ...
                        <!-- left column -->
                            ...
                            <div class="box box-primary">
                               <!-- <div class="box-header">
                                ...
                                <?php
								echo form_open_multipart('agent/saveAgent', array('name' => 'create','onSubmit'=>'return validation();')); 
								?>
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label><em class="star_red">*</em> First Name :</label>
                                            <input type="text" class="form-control" id="first_name" name="first_name" placeholder="First Name" require="require">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="username" name="username" placeholder="User Name" onKeyUp="checkUsername(this.value)">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" id="email" name="email" placeholder="E-Mail" onKeyUp="checkEmail(this.value)">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="country" id="country" class="form-control" onChange="fillState(this.value);" require="require">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="city" name="city" placeholder="City" onKeyUp="continent1('agent','getCity',this.id,'city',this.value,'country')">
...
<script type="text/javascript">
	...
	function fillState(country_id) {
			var urls = "<?php echo base_url();?>index.php/agent/state?country_id="+country_id;
			alert(urls);
