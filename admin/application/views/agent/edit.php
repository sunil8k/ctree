                        ...
                        <!-- left column -->
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="alert alert-success alert-dismissable" style="width:98%;">
                                 ...
                                 <?php
									echo form_open_multipart('agent/saveEdit', array('name' => 'change','onsubmit'=>'return validation();')); 
									?>
                                    
                                    <div class="box-body">
                                         <div class="form-group">
                                            <label for="exampleInputEmail1"> First Name :</label>
                                            <input type="text" class="form-control" id="first_name" name="first_name" placeholder="First Name" require="require"  value="<?php echo set_value('first_name',$result['first_name']); ?>" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" id="email" name="email" placeholder="E-Mail" autocomplete="off" onkeyup="checkEmail(<?php echo $result['id']; ?>)" value="<?php echo set_value('email',$result['email']); ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="mobile" name="mobile" placeholder="Mobile No" autocomplete="off"  value="<?php echo set_value('mobile',$result['mobile']); ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="password" id="password" class="form-control" value="<?php echo set_value('username',$result['username']); ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="address" id="address" class="form-control" value="<?php echo set_value('address',$result['address']); ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="country" id="country" class="form-control" onChange="fillDrop('state',this.value)">
                                            	<option value="0"></option>
                                                <?php foreach($countrys as $country) {
													?><option value="<?php echo $country->id;?>"><?php echo $country->country;?></option><?php
												}?>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputPassword1"><em class="star_red">*</em> State :</label>
                                            <select name="state" id="state" class="form-control" onChange="fillDrop('city',country.value)">
                                            	<option value="0"></option>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputPassword1"><em class="star_red">*</em> City :</label>
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputPassword1"><em class="star_red">*</em> Zip :</label>
                                            <input type="text" name="zipcode" id="zipcode" class="form-control" value="<?php echo set_value('zipcode',$result['zipcode']); ?>">
                                             <?php echo form_error('zipcode', '<span class="php-error"  style="color:#f00;">', '</span>'); ?>
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputPassword1"><em class="star_red">*</em> Active Status :</label>
                                            <input type="checkbox" name="status" id="status" class="form-control"<?php echo ($result['status'])?('checked'):(''); ?>  value="1">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputPassword1"><em class="star_red">*</em> isDelete :</label>
                                            <input type="checkbox" name="delete_status" id="delete_status" class="form-control" <?php echo $result['delete_status']?'checked':''; ?> value="1">
                                             <?php echo form_error('delete_status', '<span class="php-error"  style="color:#f00;">', '</span>'); ?>
                                             <span class="php-error" id="delete_status_msg" style="color:#f00;"></span>
                                        </div>
