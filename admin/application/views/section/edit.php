								...
								?>
                                    <div class="">
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control" id="section" name="section" placeholder="Section" require="require" onKeyUp="checkSection(this.value)" value="<?php echo $section;?>">
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control" id="html" name="html" placeholder="Section" style="height:280px;" ><?php echo $html;?></textarea>
                                           <?php echo form_error('section', '<span class="php-error"  style="color:#f00;">', '</span>'); ?>
                                           <span class="php-error" id="section_msg" style="color:#f00;"></span>
                                        </div>
									</div>
                                    <div class="box-footer">
                                    	...
                                    	<input id="section_id" name="section_id" type="hidden" value="<?php echo $id;?>">
...
function checkSection(str){
	...
	if(section ==""){
		...
		xmlhttp.open("GET","<?= base_url();?>index.php/section/checkSection?section="+section+"&id="+section_id,true);
		xmlhttp.send();	
