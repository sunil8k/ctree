                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                               ...
                                               <?php if($this->session->userdata('username')=='admin'){ ?>
                                                ...
                                                <a  href="<?= base_url();?>index.php/section/active?id=<?php echo $result->id; ?>&view=index" onclick="return confirm('Are you sure you want to Un-publish ?');" title="Un-publish" ><i class="glyphicon glyphicon-ok-circle"></i></a>
                                                <?php }else { ?>
                                                <a href="<?= base_url();?>index.php/section/active?id=<?php echo $result->id; ?>&view=index" onclick="return confirm('Are you sure you want to Publish ?');" title="Publish" ><i class="glyphicon glyphicon-ok-sign"></i></a>
                                                <?php } ?>
                                                <a  href="<?= base_url();?>index.php/section/delete?del=<?php echo $result->id; ?>&view=index" onclick="return confirm('Are you sure you want to Delete ?');" title="Delete"><i class="glyphicon glyphicon-remove-circle"></i></a>
                                           		<a href="<?= base_url();?>index.php/section/editSection?id=<?php echo $result->id; ?>&view=index" onclick="return confirm('Are you sure you want to Update ?');" title="Update" ><i class="glyphicon glyphicon-pencil"></i></a> 
                                               <?php } ?>
                                                </td>
                                            </tr>
