...
/////////////////////////////////////////////////////////////
    ...
    <body class="skin-blue">
        ...
        <?php $this->load->view("layout/left_content");?>
                    ...
                    <div class="row">
                        <!-- left column -->
                            ...
                            <div class="box box-primary">                                
                                ...
                                <?php
								echo form_open_multipart('category/update', array('name' => 'create','onsubmit'=>'return validation();')); 
								?>
                                <div class="box-body" id="datad">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="category" name="category" placeholder="Category" require="require" value="<?php echo $val[0]->category;?>">
                                    ...
                                    <!-- /.box-body -->
									<div class="form-group rmDiv" id="aaatext564">
                                        <label for="exampleInputEmail1"><em class="star_red">*</em> Parent :</label>
                                        <select class="form-control catRm" name="parent[]" require="require" id="564" onChange="parentCategory(this.value,'564')">
                                            <option value="0">Parent 1</option>
                                            <?php foreach($results as $result) {?>
                                            <option value="<?php echo $result->id;?>" <?php echo ($parent[0] == $result->id)?('selected'):('');?>><?php echo $result->category;?></option>
                                            <?php } ?>
                                        </select>
            ...
            <script type="text/javascript">parentCategory('<?php echo $parent[0];?>','564');</script>
                                    </div>
                                </div>
                                <div class="box-footer">
                                	<input type="hidden" id="category_id" name="category_id" value="<?php echo $results[0]->id;?>" >
  ...
  function validation()
	 {
		...
		/*var category_key = document.getElementById("category_key").value;
		if(document.getElementById(category_key).value == 0){
			
			document.getElementById(category_key+"_msg").innerHTML='<div class="error-left"></div><div class="error-inner">This field is required.</div>';	
			
			flag=1;
		}
		else {
			document.getElementById(category_key+"_msg").innerHTML="";
		}*/
