								...
								?>
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="checkbox" class="form-control" id="daily_challenge" name="daily_challenge" placeholder="Daily Challenge" value="1" <?php echo $results[0]['daily_challenge']?('checked'):('');?>>
