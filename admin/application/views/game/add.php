								...
								?>
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="game" name="game" placeholder="Game" require="require">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="cost" name="cost" placeholder="Cost" require="require">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputPassword1"><em class="star_red"></em> Daily Challenge</label>
                                            <input type="checkbox" class="form-control" id="daily_challenge" name="daily_challenge" placeholder="Daily Challenge" value="1" <?php if(isset($_REQUEST['daily'])) { echo $_REQUEST['daily']?('checked'):(''); }?>>
                                           <?php echo form_error('daily_challenges', '<span class="php-error"  style="color:#f00;">', '</span>'); ?>
                                           <span class="php-error" id="daily_challenges_msg" style="color:#f00;"></span>
                                        </div>
                                    </div><!-- /.box-body -->
