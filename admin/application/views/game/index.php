	...
	<?php $this->load->view("layout/left_content");?>
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>
                        Puzzle
                        <a href="<?= base_url()?>index.php/game/add" style="float: right; margin-right: 10px;">
									  ...
									  <?php
                                          ...
                                          ?>                                       
                                            ...
                                            <td ><?php echo $result->id; ?></td>
                                                ...
                                                <td><a href="<?= base_url();?>index.php/game/changeOrder?id=<?php echo $result->id; ?>&flow=up"><img style="width:30px;" src="<?= base_url();?>assets/img/up.png" ></a><a href="<?= base_url();?>index.php/game/changeOrder?id=<?php echo $result->id; ?>&flow=down"><img style="width:30px;" src="<?= base_url();?>assets/img/down.png" ></a></td>
                                                <td>
                                               ...
                                               <?php if($this->session->userdata('type') =='admin'){ ?>
                                                ...
                                                <a  href="<?= base_url();?>index.php/game/active?id=<?php echo $result->id; ?>&view=index" onclick="return confirm('Are you sure you want to deactivate ?');" title="active" ><i class="glyphicon glyphicon-ok-circle"></i></a>
                                                <?php }else { ?>
                                                <a href="<?= base_url();?>index.php/game/active?id=<?php echo $result->id; ?>&view=index" onclick="return confirm('Are you sure you want to activate ?');" title="deactive" ><i class="glyphicon glyphicon-ok-sign"></i></a>
                                                <?php } ?>
                                                <a  href="<?= base_url();?>index.php/game/delete?del=<?php echo $result->id; ?>&view=index" onclick="return confirm('Are you sure you want to Delete ?');" title="Delete"><i class="glyphicon glyphicon-remove-circle"></i></a>
                                                <a href="<?= base_url();?>index.php/game/edit?id=<?php echo $result->id; ?>&view=index" onclick="return confirm('Are you sure you want to Edit ?');" title="Update" ><i class="glyphicon glyphicon-pencil"></i></a> 
                                               <?php } ?>
                                                </td>
                                            </tr>
