									  ...
									  <?php
                                          ...
                                          ?>                                       
                                            ...
                                            <td><?php echo $result->id; ?></td>
                                                ...
                                                <td><?php echo $result->applied_date; ?></td>
                                                <td><a target="_blank" href="<?php if($result->doc) { echo FRONT_BASE_URL.$result->doc; } else {echo "#";} ?>">Download</a></td>
                                                <td>
                                			    <a style="cursor:pointer;" title="View" onClick="applied(<?php echo $result->id; ?>)" data-toggle="modal" data-target="#compose-modal"><i class="glyphicon glyphicon-search"></i></a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Applied Profile</h4>
                    </div>
...
function applied(id)
{
	$('#datad').html('<img style="margin-left: 230px;margin-top: 100px;margin-bottom: 110px;" src="<?= base_url();?>assets/images/ajax-loader2.gif"/>');
		    $.ajax({
                        url: '<?= base_url();?>index.php/post/applyView?apply_id='+id,
                         type:'POST',
                       //	dataType: 'json',
                          error: function(){
