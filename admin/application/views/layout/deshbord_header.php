...
<header class="main-header">
        ...
        <a href="index.html" class="logo">
          ...
          <span class="logo-lg"><img src="<?= base_url();?>assets/dist/img/logo.png" width="168"></span>
        </a>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <?php  $image = $this->users_model->profileImage(); ?>
                                    ...
                                    <p>
                                       ...
                                       <?php $newDate = date("M-Y", strtotime($image['date_time']));?>
                                        <small>Member since <?php echo $newDate; ?></small>
                                    </p>
                                </li>
                                <!-- Menu Body -->
                                <li class="user-body">
                                    ...
                                    <div class="col-xs-4 text-center">
                                        <a href="<?= base_url();?>index.php/users/changepassword">Change Password</a>
                                    </div>
                                    <!--<div class="col-xs-4 text-center">
                                        <a href="#">Friends</a>
                                    </div>-->
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="<?= base_url();?>index.php/users/editUser" class="btn btn-default btn-flat">Profile</a>
                                    </div>
