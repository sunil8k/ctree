	...
	<?php $this->load->view("layout/left_content");?>
            ...
            <aside class="right-side">                
                ...
                <!--<section class="content-header">
                    <h1>
                        Customer Leads
                        <a href="<?= base_url();?>index.php/agent/adduser?view=index" style="float: right; margin-right: 10px;">
									  ...
									  <?php
                                          ...
                                          ?>
                                            <tr>
                                                ...
                                                <td><?php echo date ("Y m d - h:i a",strtotime($result->create_date));?></td>
                                                <td>
                                               ...
                                               <?php if($this->session->userdata('username')=='admin'){ ?>
                                                ...
                                                <a  href="<?= base_url();?>index.php/leads/active?id=<?php echo $result->id; ?>&view=index" onclick="return confirm('Are you sure you want to Un-publish ?');" title="Un-publish" ><i class="glyphicon glyphicon-ok-circle"></i></a>
                                                <?php }else { ?>
                                                <a href="<?= base_url();?>index.php/leads/active?id=<?php echo $result->id; ?>&view=index" onclick="return confirm('Are you sure you want to Publish ?');" title="Publish" ><i class="glyphicon glyphicon-ok-sign"></i></a>
                                                <?php } ?>
                                                <a  href="<?= base_url();?>index.php/leads/delete?del=<?php echo $result->id; ?>&view=index" onclick="return confirm('Are you sure you want to Delete ?');" title="Delete"><i class="glyphicon glyphicon-remove-circle"></i></a>
                                           		<a href="<?= base_url();?>index.php/leads/editUser?id=<?php echo $result->id; ?>&view=index" onclick="return confirm('Are you sure you want to Update ?');" title="Update" ><i class="glyphicon glyphicon-pencil"></i></a> 
                                               <?php } ?>
                                                </td>
                                            </tr>
                                         <?php } 
...
function profile(id)
{
	...
	$.ajax({
		url: '<?= base_url();?>index.php/leads/view?id='+id,
		type:'POST',
		//	dataType: 'json',
		error: function(){
