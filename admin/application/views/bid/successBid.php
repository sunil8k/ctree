                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
									  ...
									  <?php
                                          ...
                                          ?>
                                            <tr>
                                                <td><?php echo $result->bid_id; ?></td>
                                                <td><?php echo $result->agent_id; ?></td>
                                                <td><?php echo $result->first_name." ".$result->last_name; ?></td>
                                                <td><?php echo $result->mobile; ?></td>
                                                <td><?php echo $result->email; ?></td>
                                                <td><?php echo $result->amount; ?></td>
                                                <td><?php echo $result->lead_id; ?></td>
                                                <td><?php echo $result->sku; ?></td>
                                                <td><?php echo $result->customer_id; ?></td>
                                                <td><?php echo date ("Y m d - h:i a",strtotime($result->bid_date));?></td>
                                                <td>
                                        ...
                                        <tr style="border:none;">
                                            <td colspan="11"  align="center" style="padding-top:5px;"><span style="color:#666;"><strong>Data Not Found</strong></span></td> 
                                        </tr>
                                        <?php } ?>
                                        </tbody>
                                    </table>
