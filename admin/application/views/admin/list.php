	...
	<?php $this->load->view("layout/left_content");?>
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>
                        Backend Users
                        <a href="<?= base_url();?>index.php/admin/adduser?view=index" style="float: right; margin-right: 10px;">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Name</th>
                                                <th>Username</th>
                                                <?php if($this->session->userdata('username')=='admin'){ ?><th>Password</th><?php }?>
                                                <th>Email</th>
                                                <th>Mobile</th>
                                                <th>Created Date</th>
                                                <th>Action</th>
									  ...
									  <?php
                                          ...
                                          ?>                                       
                                            ...
                                            <tr>
                                                ...
                                                <?php if($this->session->userdata('username')=='admin'){ ?><td><?php echo $result->password_text; ?></td><?php }?>
                                               ...
                                               <?php if($this->session->userdata('username')=='admin'){ ?>
                                                ...
                                                <a  href="<?= base_url();?>index.php/admin/active?id=<?php echo $result->id; ?>&view=index" onclick="return confirm('Are you sure you want to Un-publish ?');" title="Un-publish" ><i class="glyphicon glyphicon-ok-circle"></i></a>
                                                <?php }else { ?>
                                                <a href="<?= base_url();?>index.php/admin/active?id=<?php echo $result->id; ?>&view=index" onclick="return confirm('Are you sure you want to Publish ?');" title="Publish" ><i class="glyphicon glyphicon-ok-sign"></i></a>
                                                <?php } ?>
                                                <a  href="<?= base_url();?>index.php/admin/delete?id=<?php echo $result->id; ?>&view=index" onclick="return confirm('Are you sure you want to Delete ?');" title="Delete"><i class="glyphicon glyphicon-remove-circle"></i></a>
                                           		<a href="<?= base_url();?>index.php/admin/editUser?id=<?php echo $result->id; ?>&view=index" onclick="return confirm('Are you sure you want to Update ?');" title="Update" ><i class="glyphicon glyphicon-pencil"></i></a>
                                           		<a href="<?= base_url();?>index.php/admin/permission?id=<?php echo $result->id; ?>&view=index" onclick="return confirm('Are you sure you want to change permissions ?');" title="Permission" ><i class="glyphicon glyphicon-lock"></i></a> 
                                               <?php } ?>
                                                </td>
                                            </tr>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title"><i class="fa fa-envelope-o"></i>Administrator</h4>
                    </div>
...
function profile(id)
{
	$('#datad').html('<img style="margin-left: 230px;margin-top: 100px;margin-bottom: 110px;" src="<?= base_url();?>assets/images/ajax-loader2.gif"/>');
		    $.ajax({
                        url: '<?= base_url();?>index.php/admin/view?id='+id,
                         type:'POST',
                       //	dataType: 'json',
                          error: function(){
