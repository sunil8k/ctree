        ...
        <?php $this->load->view("layout/left_content");?>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                    	Add Category
                        <a href="<?= base_url();?>index.php/ads/" style="float: right; margin-right: 10px;">
                    ...
                    <div class="row">
                        <!-- left column -->
                            ...
                            <div class="box box-primary">                                
                                ...
                                <?php
								echo form_open_multipart('ads/save', array('name' => 'create','onsubmit'=>'return validation();')); 
								?>
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="exampleInputPassword1"><em class="star_red">*</em> Title</label>
                                            <input type="text" class="form-control" id="title" name="title" placeholder="Title" require="require">
                                           <?php echo form_error('ads', '<span class="php-error"  style="color:#f00;">', '</span>'); ?>
                                           <span class="php-error" id="ads_msg" style="color:#f00;"></span>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1"><em class="star_red">*</em> URL</label>
                                            <input type="text" class="form-control" name="url" id="url" placeholder="URL"  >
                                             <span class="php-error" id="url_msg" style="color:#f00;"></span>
                                        </div>
                                       
                                        <div class="form-group">
                                        <label for="exampleInputPassword1"><em class="star_red">*</em> File</label>
                                            <input type="file" name="ads" id="ads" >
                                             <span class="php-error" id="ads_msg" style="color:#f00;"></span>
                                        </div>
