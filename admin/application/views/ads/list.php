	...
	<?php $this->load->view("layout/left_content");?>
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>
                        Ads
                        <a href="<?= base_url();?>index.php/ads/add?view=index" style="float: right; margin-right: 10px;">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box">
                                ...
                                <div class="alert alert-success alert-dismissable" style="width:98%;">
                                        ...
                                        <b></b> <?php echo $this->session->flashdata('success'); ?>
                                    </div>
                                    <?php } ?>
									  ...
									  <?php
                                          ...
                                          ?>                                       
                                            ...
                                            <td><?php echo $result->id; ?></td>
                                                ...
                                                <td>
                                                <!--<a style="cursor:pointer;" target="_blank" title="View" href="http://<?php echo $result->url; ?>" ><i class="glyphicon glyphicon-search"></i></a>-->
                                			    <a style="cursor:pointer;" title="View" onClick="ads(<?php echo $result->id; ?>)" data-toggle="modal" data-target="#compose-modal"><i class="glyphicon glyphicon-search"></i></a>
                                               <?php if($this->session->userdata('type') =='admin'){ ?>
                                                <?php if($result->status){ ?>
                                                	<a  href="<?= base_url();?>index.php/ads/active?id=<?php echo $result->id; ?>&view=index" onclick="return confirm('Are you sure you want to deactivate ?');" title="active" ><i class="glyphicon glyphicon-ok-circle"></i></a>
                                                <?php }
												else { ?>
                                                	<a href="<?= base_url();?>index.php/ads/active?id=<?php echo $result->id; ?>&view=index" onclick="return confirm('Are you sure you want to activate ?');" title="deactive" ><i class="glyphicon glyphicon-ok-sign"></i></a>
                                                <?php } ?>
                                                <a  href="<?= base_url();?>index.php/ads/delete?id=<?php echo $result->id; ?>&view=index" onclick="return confirm('Are you sure you want to Delete ?');" title="Delete"><i class="glyphicon glyphicon-remove-circle"></i></a>
                                               <?php } ?>
                                                </td>
                                            </tr>
...
function ads(id) {
	...
	$('#datad').html('<img style="margin-left: 230px;margin-top: 100px;margin-bottom: 110px;" src="<?= base_url();?>assets/images/ajax-loader2.gif"/>');
		    $.ajax({
                        url: '<?= base_url();?>index.php/ads/view?id='+id,
                         type:'POST',
                       //	dataType: 'json',
                          error: function(){
